...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
    return (_jsx(DayPicker, { showOutsideDays: showOutsideDays, className: cn("p-3", className), classNames: {
            ...
            IconLeft: ({ className, ...props }) => (_jsx(ChevronLeftIcon, { className: cn("h-4 w-4", className), style: props.style })),
            IconRight: ({ className, ...props }) => (_jsx(ChevronRightIcon, { className: cn("h-4 w-4", className), style: props.style })),
        }, ...props }));
}
