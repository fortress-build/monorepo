...
<Tabs defaultValue="table">
  ...
  <TabsContent value="table">
    ...
    | └─ coverage | <span style={{color: "#22c55e"}}>✓</span> | Reference\<[Coverage](/fhir/resources/coverage)> | The party(s) that may contribute to payment |
    ...
    | └─ party | <span style={{color: "#22c55e"}}>✓</span> | Reference\<[Patient](/fhir/resources/patient)\| [RelatedPerson](/fhir/resources/relatedperson)\| [Organization](/fhir/resources/organization)> | Responsible entity |
...
The Account itself does not include information about the charges, payments or adjustments, but rather those resources, such as [ChargeItem](/fhir/resources/chargeitem) point to the account to which they apply. Payment and adjustment resources have not yet been developed.
