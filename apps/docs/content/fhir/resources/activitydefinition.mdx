...
<Tabs items={["structure", "json", "typescript"]} defaultValue="structure">
  <Tab value="structure">
    ...
    | └─ subjectReference | | Reference\<[Group](/fhir/resources/group)> | Type of individual specified as a group reference |
    ...
    | └─ type | <span style={{color: "#22c55e"}}>✓</span> | code | patient \| practitioner \| related-person \| device |
    ...
    | └─ path | <span style={{color: "#22c55e"}}>✓</span> | string | The path to the element to be set dynamically |
    | └─ expression | <span style={{color: "#22c55e"}}>✓</span> | Expression | An expression that provides the dynamic value for the customization |
  </Tab>
