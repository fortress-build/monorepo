...
|------|-------------|----------|----------|-------|
| code | Must be "allergies" | <span style={{color: "#22c55e"}}>✓</span> | false | string |
...
| Name | Description | Required | Is Array | Types |
|------|-------------|----------|----------|-------|
| code | Must be "pedigree-list" | <span style={{color: "#22c55e"}}>✓</span> | false | string |
| patient | The patient with whom the list is associated | | false | string |
| subject | The patient with whom the list is associated | | false | string |
...
| Name | Description | Required | Is Array | Types |
|------|-------------|----------|----------|-------|
| code | Must be "immunizations" | <span style={{color: "#22c55e"}}>✓</span> | false | string |
| patient | The patient with whom the list is associated | | false | string |
| subject | The patient with whom the list is associated | | false | string |
...
| Name | Description | Required | Is Array | Types |
|------|-------------|----------|----------|-------|
| code | The type of list to search for. Must be set to "problems" | <span style={{color: "#22c55e"}}>✓</span> | false | string |
