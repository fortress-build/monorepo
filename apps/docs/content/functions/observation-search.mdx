...
|-------------|-------------|-------------|-----------|
| combo-code (String) | This is the LOINC code corresponding to value returned in this observation. | true | false |
| combo-value-concept (String) | Type of data returned. See the valueCodeableConcept response element for more information. | true | false |
...
| value-concept (String) | Type of data returned. See the valueCodeableConcept response element for more information. | true | false |
| value-string (String) | Type of data returned. See the valueString response element for more information. | true | false |
