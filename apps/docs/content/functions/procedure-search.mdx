...
|------|-------------|-------------|-----------|
| category (String) | A code that classifies the procedure. This will always be SNOMED code 387713003 (Surgical procedure) for the Procedure (Surgical history) API. | true | false |
| patient (String) | The Patient FHIR resource ID. | conditional | false |
| subject (String) | Subject of the Procedure. | conditional | false |

### Post-filter Parameters
| Name | Description | Is Optional | Array |
|------|-------------|-------------|--------|
| code (String) | External codes associated with the procedure. | true | false |
| date (String) | When the procedure was performed | true | false |
| status (String) | The status of the Procedure. Refer to the response element for more information. | true | false |
